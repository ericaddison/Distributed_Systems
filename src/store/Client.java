...
public class Client {
	...
	public static void main (String[] args) {
        ...
        // appropriate responses form the server
    	  ...
    	  // expected format: purchase <user-name> <product-name> <quantity>
    	  if (tokens.length < 4) {
        ...
        // appropriate responses form the server
    	  ...
    	  //  or, list all orders of the user as <orderId> <productName> <quantity>
    	  //
    	  //
    	  //
        ...
        // appropriate responses form the server
    	  ...
    	  //    print one line per product (if product sold out, list quantity as 0)
